...
13:                                               ; preds = %7
  ...
  %17 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @frmt_spec.anonymous_tuple, i64 0, i64 0), i64 %16), !dbg !158
  br label %7, !dbg !159
...
define i1 @s0({ i64, i64, i64, i64 } %0) !dbg !166 {
  ...
  %7 = icmp sle i64 0, %6, !dbg !173
  %8 = extractvalue { i64, i64, i64, i64 } %0, 1, !dbg !174
  %9 = icmp sle i64 %8, 0, !dbg !175
...
!172 = !DILocation(line: 216, column: 10, scope: !168)
