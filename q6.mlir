module attributes {llvm.data_layout = ""} {
  ...
  llvm.func @_mlir_ciface_query(%arg0: !llvm.struct<(i64, ptr<i64>, ptr<i64>, ptr<i64>, ptr<i64>)>) attributes {llvm.emit_c_interface, sym_visibility = "private"} {
  ...
  llvm.func @s0(%arg0: !llvm.struct<(i64, i64, i64, i64)>) -> i1 attributes {sym_visibility = "private"} {
    ...
    %7 = llvm.extractvalue %arg0[1 : index] : !llvm.struct<(i64, i64, i64, i64)>
    %8 = llvm.icmp "sle" %6, %7 : i64
